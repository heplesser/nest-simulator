...
function( NEST_PRINT_CONFIG_SUMMARY )
  ...
  if ( NOT NESTKERNEL_API_CXX )
    ...
    message( "    Cython          : Not run; using pre-generated ${NESTKERNEL_API_CXX}" )
  endif ()
  ...
  if ( HAVE_LIBLTDL )
    ...
    if ( APPLE AND with-ltdl AND NOT with-static-linking )
  ...
  if ( NESTKERNEL_API_CXX AND NOT EXISTS "${NESTKERNEL_API_CXX}" )
    message( "" )
    message( "ATTENTION!" )
    message( "You configured NEST with -DNESTKERNEL_API_CXX=${NESTKERNEL_API_CXX}" )
    message( "but the specified file is not yet present:" )
    message( "  ${NESTKERNEL_API_CXX}" )
    message( "The build will fail at the compile step until this file is in place." )
    message( "" )
    message( "--------------------------------------------------------------------------------" )
    message( "" )
  endif ()
